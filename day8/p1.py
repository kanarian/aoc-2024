...
for key, coordinates in antenna_resonance_position_dict.items():
    ...
    for coord_pair in all_coord_pairs:
        ...
        print(f"diffRow {diffRow}, diffCol {diffCol}")
        antinode_coord_one = (coord_one[0] + diffRow, coord_one[1] + diffCol)
        antinode_coord_two = (coord_two[0] - diffRow, coord_two[1] - diffCol)
...
# print(f"inbound_antinodes {inbound_antinodes}")
# print(f"deduped inbound antinodes {deduped_inbound_antinodes}")
